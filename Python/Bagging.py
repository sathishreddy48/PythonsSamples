# -*- coding: utf-8 -*-
"""
Created on Mon Sep  3 12:53:26 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  3 12:38:11 2018
...
def export_all_trees(best_est, prefix):
    ...
    for est in best_est.estimators_: 
        ...
        graph.write_pdf("D:/Users/Algorithmica/Downloads/all/Trees/" + prefix + str(n_tree) + ".pdf")
        n_tree = n_tree + 1
